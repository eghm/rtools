...
if [ -e it/internal-tools/src/main/resources/rice-testharness-default-log4j.properties ]
then
# pre split
...
# post split
    cp $1-log4j.properties rice-middleware/it/internal-tools/src/main/resources/rice-testharness-default-log4j.properties
    mkdir -p rice-middleware/core/impl/src/main/java/com/veerasundar/dynamiclogger
    cp ../rtools/etc/NewLogFileForEachRunAppender.java rice-middleware/core/impl/src/main/java/com/veerasundar/dynamiclogger/
fi
