...
export DBUID=$(xml sel -t -m "/Beans/Bean/name[contains(text(), '$DBNAME')]" -v "concat(../identifier/string, '')" ~/.squirrel-sql/SQLAliases23.xml)
...
xml ed -d "//Bean/identifier/string[contains(text(), '$DBUID')]/../.."  ~/.squirrel-sql/SQLAliases23.xml > ~/.squirrel-sql/SQLAliases23.xml.del
mv ~/.squirrel-sql/SQLAliases23.xml.del ~/.squirrel-sql/SQLAliases23.xml
xml ed -d "//Bean/aliasIdentifier/string[contains(text(), '$DBUID')]/../.."  ~/.squirrel-sql/SQLAliases23_treeStructure.xml > ~/.squirrel-sql/SQLAliases23_treeStructure.xml.del
