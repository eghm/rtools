# $1 server, $2 jmeter test name without the .jmx $3 number of threads $4 number of loops $5 ramp seconds $6 wiki username $7 wiki passtoken $8 java agent line to be appended to CATALINA_OPTS
if [ ! -e "$2".jmx ] 
then
...
parallel --tag --nonall --sshloginfile ~/servers.txt rtools/bin/loadtest/mkDtsTomcatLogDir.sh $8
