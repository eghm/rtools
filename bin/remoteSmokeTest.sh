# rice.version remote.public.url remote.driver.saucelabs.browser remote.driver.saucelabs.version remote.driver.saucelabs.platform  
source ~/.bash_profile
cd ~/$1
...
export TEST_PARAMS="";
while [ -s ../smokeTestList.csv ] 
do
	export TEST=$(tail -n 1 ../smokeTestList.csv | cut -d , -f 1)
	...
	sed '$d' ../smokeTestList.csv > ../smokeTestList.cut.csv
	mv ../smokeTestList.cut.csv ../smokeTestList.csv
